...
- **Deploy-Latenz** (2026-06-21/23/25/26). Single-Commit ~50–90s bis live (am 2026-06-26: Erst-Check nach 65s noch alte Version, nach +40s live). Verifikation im 30-s-Takt 2–3× wiederholen, bevor „nicht live" gefolgert wird. Mehrere Dateien optional in EINEM `push_files`-Commit bündeln.
...
> **▶ NÄCHSTER LAUF (ab 2026-06-27):** **(A) Wesel ERLEDIGT 2026-06-25** (`dda4aff`). **(B) FAQPage index.html ERLEDIGT 2026-06-26** (Commit `309f38a`, 2 JSON-LD-Blöcke, FAQPage 5 Fragen, live verifiziert). **NÄCHSTES:** Doorway-Differenzierung mit `seo-content` fortsetzen — nächsten Kandidaten per 5-Gramm-Jaccard wählen (offen: recklinghausen, dinslaken, dorsten, duisburg, herne, oberhausen, bottrop, haltern). FAQPage-Ausroll abgeschlossen (Service-Seiten haben keinen sichtbaren FAQ-Block, daher nicht anwendbar; alle Stadtseiten haben FAQPage). BreadcrumbList-Konsistenz auf allen 6 Service-Seiten hergestellt (2026-06-26). Offen GSC: Indexierung für `zauberer-wesel.html` + `/` (manuell durch Inhaber, Deep-Link liefert 404). Nach jeder Änderung Standard-Verifikation.
- [x] **GSC-Sitemap-Recrawl ERLEDIGT (2026-06-23).** `sitemap.xml` „Erfolgreich", 25 Seiten, 0 Fehler. Nur noch beiläufig prüfen.
- [ ] **Neue Stadtseiten indexieren** (2026-06-17). Beantragt: essen, gelsenkirchen (23.06.), marl (23.06.), herten (24.06.). **OFFEN: `zauberer-wesel.html` (Update 2026-06-25) UND `/` (FAQPage-Update 2026-06-26) in GSC einreichen** — Deep-Link zur URL-Prüfung liefert 404, daher manuell durch Inhaber. Rest: oberhausen, recklinghausen, duisburg, herne, dorsten, bottrop, dinslaken, haltern. GSC-„keine verweisende Sitemap" = Crawl-Lag, kein Defekt.
- [ ] **⭐ Polterabend-/Junggesellenabschied-Seite (freigabepflichtig, HÖCHSTE Priorität).** „zauberer polterabend" = **215 Impr / 0 Klicks** (2026-06-26). Alte URL `/galerie/junggesellenabschied/` → 301 auf `fotogalerie.html` (kein Polterabend-Text). KEINE Anlass-Seite vorhanden. Empfehlung: neue `polterabend-zauberer.html` ODER wahrer Polterabend-Abschnitt auf bestehender Seite (KEINE neuen Preise). Freigabepflichtig → auf Inhaber warten.
